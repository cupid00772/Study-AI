# 綜合學習狀態追蹤表 (Consolidated Learning Status)

這份文件用於綜合追蹤各科目的學習狀態。當使用「掃題大師 (Question Sweeper)」或其他測驗 Skill 時，結果將會自動更新於此，方便統一管理與檢視。
...
| 章節 (Chapter)                                                       | 狀態 | 易錯觀念 / 常錯題型                                                                                                                                                                                            | 已出過的考點 / 上次測驗            |
| :------------------------------------------------------------------- | :--: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------- |
| **1. 極限與連續 (Limits and Continuity)**                      |  🟡  | 忘記斜漸近線 (Slant Asymptote) 的求法公式 ($m = \lim \frac{f(x)}{x}$, $c = \lim (f(x)-mx)$)                                                                                                                | Sweep Exam                         |
| **2. 導數與微分 (Derivatives and Differentiation)**            |  🟢  | 計算偶有小粗心，但基本觀念清楚                                                                                                                                                                                 | Sweep Exam                         |
| **3. 導數的應用 (Applications of Derivatives)**                |  🟢  | 最佳化問題 (Optimization Problems) 觀念解題上較不熟練，但整體計算正確                                                                                                                                          | Sweep Exam                         |
| **4. 積分 (Integrals)**                                        |  🟢  | 基礎穩固，各式積分技巧與定理應用皆能正確作答                                                                                                                                                                   | Sweep Exam                         |
...
| 章節 (Chapter)                                 | 狀態 | 易錯觀念 / 常錯題型                                    | 上次測驗日期 |
| :--------------------------------------------- | :--: | :----------------------------------------------------- | :----------- |
| **Ch 2.5-2.6 Joint PMF**                 |  🟢  | 基礎代入全對，接下來將挑戰缺乏明確提示的擬真考題       | 2026-06-08   |
| **Ch 4.1-4.4 Discrete Random Variables** |  🟢  | 基礎代入全對，已能正確套用公式，接下來挑戰長篇題幹解析 | 2026-06-08   |
